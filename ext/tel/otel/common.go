...
const (
	...
	CRequestContentLength  = "http.client.request_content_length"  // Incoming request bytes total
	CResponseContentLength = "http.client.response_content_length" // Incoming response bytes total
	CServerLatency         = "http.client.duration"                // Incoming end to end duration, microseconds
)
